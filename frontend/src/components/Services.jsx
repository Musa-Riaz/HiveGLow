...
const Services = () => {
    ...
    return (
        <section className="py-16 sm:py-20 bg-background dark:bg-background text-text flex justify-center relative overflow-hidden">
            ...
            <div className="container px-4 relative z-10">
                ...
                <motion.div
                    className={`grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 ${showAll ? "2xl:grid-cols-5" : ""
