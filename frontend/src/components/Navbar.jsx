...
const Navbar = () => {
  ...
  return (
    <div
      className={cn(
        "z-index   bg-white  dark:bg-darkmode  fixed top-0 flex items-center w-full p-6 px-6 ",
        scrolled && " border-b border-yellow-600 shadow-sm"
      )}
    >
<p className="w-full font-bold text-yellow-600">Hive Glow</p>
<div 
className="md:ml-auto md:justify-end justify-between w-full flex items-center gap-x-2"
>
  <ul className="text-yellow-600 flex space-x-10">
