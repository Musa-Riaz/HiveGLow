...
const Contact = () => {
  ...
  return (
    <div
      className='py-20 flex justify-center bg-secondary text-text h-full sm:h-screen'
    >
      <div className='px-6 w-full flex flex-col items-center gap-10 md:flex-row justify-evenly'>
        <div className='flex w-full sm:w-[30vw] pl-5 sm:pl-0 flex-col gap-4 md:gap-8'>
          <h2 className='text-4xl font-bold '>
            Contact Us
          </h2>
          <h3><span className='text-xl font-bold'>Our Location<br /></span>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perferendis in soluta placeat. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatem, excepturi.</h3>
        ...
        <div>
          <form className='flex flex-col gap-4 bg-background w-[80vw] sm:w-[30vw] p-6 rounded-lg' ref={form} onSubmit={handleSubmit}>
